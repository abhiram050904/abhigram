...
const { creategroup, updategroup, getGroupdetails, addmemberstogroup, deleteMembersFromGroup, getgroupmessages, searchUserGroups } = require("../controllers/groupcontroller");
...
router.get('/search/user',authMiddleware,searchUserGroups);
